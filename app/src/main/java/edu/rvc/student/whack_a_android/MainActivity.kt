package edu.rvc.student.whack_a_android
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val h = btnImgButton.getLayoutParams().height
        val w = btnImgButton.getLayoutParams().width
        ...
        btnControl.setOnClickListener{
            if (btnControl.text == "Start"){
                btnImgButton.getLayoutParams().height = h
                btnImgButton.getLayoutParams().width = w
                btnImgButton.requestLayout()
        ...
        btnImgButton.setOnClickListener{
            ...
            if (score == 1000){
                ...
                txtScore.text = "Score: " + score.toString()
                btnImgButton.getLayoutParams().height = ((btnImgButton.getLayoutParams().height) -12)
                btnImgButton.getLayoutParams().width = ((btnImgButton.getLayoutParams().width) -12)
                btnImgButton.requestLayout()
            }
    ...
    fun ChangeImage(){
        y = ((Math.random () * getScreenHeight()) ) .toFloat ()
